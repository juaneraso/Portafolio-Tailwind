...
const Contact = () => {
   ...
   return (
     <div className="bg-blue-950 border border-blue-950 py-8">
       <h1 className="text-center mt-2 text-4xl text-white font-Changa mb-3">Contact</h1>
 
       <div className="flex justify-center items-center flex-wrap">
         <a href={whatsapp_url} target="_blank" rel="noopener noreferrer" className="mx-4 my-2">
           <img className="w-24 h-24" src={whatsapp} alt="imagen_whatsapp" />
         </a>
 
         <a href={linkedin_url} target="_blank" rel="noopener noreferrer" className="mx-4 my-2">
           <img className="w-24 h-24" src={linkedin} alt="imagen_linkedin" />
         </a>
 
         <a href={github_url} target="_blank" rel="noopener noreferrer" className="mx-4 my-2">
           <img className="w-24 h-24" src={github} alt="imagen_github" />
         </a>
 
         <a href={email_url} target="_blank" rel="noopener noreferrer" className="mx-4 my-2">
           <img className="w-24 h-24" src={email} alt="imagen_email" />
         </a>
       </div>
 
       <h1 className="text-center text-3xl mt-6 mb-4 text-white">Juan Guillermo - 2024</h1>
     </div>
   );
 };
